...
<span style="position:absolute;top:0px;left:0px;height:25px;width:250px;" id="mover"></span><table style="border:1px solid gray">
	...
	<tr>
		<th> Nome:</th>
		<td><input name="text" type="text" id="nome" title="Coloque aqui o nome de quem voc� deve ou de quem te deve!" /></td>
	</tr>
	<tr>
		<th>Pagar:</th>
		<td><input name="text2" type="text" id="pagar" title="Coloque aqui o valor que voc� vai pagar(Valor Num�rico)" value="0" /></td>
	</tr>
	<tr>
		<th>Receber:</th>
		<td><input name="text2" type="text" id="receber" title="Coloque aqui o valor que voc� vai receber(Valor Num�rico)" value="0" /></td>    
